...
function Contact() {
  ...
  return (
    <div id='Contact' className='md:pt-24'>
      <div className="grid max-w-screen-xl pt-8 sm:pt-0 grid-cols-1 gap-8 px-8 py-16 mx-auto rounded -lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
      ...
      <div className="grid justify-center pt-6 lg:justify-between bg-[#181818]">
        ...
        <div className="flex justify-center pt-4 pb-2 space-x-4 lg:pt-0 lg:col-end-13 md:mx-10 md:pb-5">
